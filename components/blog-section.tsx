...
const blogPosts = [
  {
    id: 1,
    date: "July 14, 2025",
    title: "The Impact of Your Donations: Real Stories from Scholarship Recipients",
    image: "/young-african-child-sitting-against-orange-wall.jpg",
  },
  {
    id: 2,
    date: "June 28, 2025",
    title: "How Scholarships Empower Students for Academic Success",
    image: "/group-of-children-sitting-together-outdoors.jpg",
  },
  {
    id: 3,
    date: "June 15, 2025",
    title: "Supporting Education: Why Scholarships Matter for Student Success",
  ...
  return (
    <section className="py-16 md:py-24 bg-cream">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-12">
          <p className="text-teal font-semibold mb-3 text-5xl">Blog</p>
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div className="max-w-2xl">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-charcoal mb-4 text-balance">
